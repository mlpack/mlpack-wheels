...
"C:\Program Files (x86)\Microsoft Visual Studio\2019\Enterprise\VC\Tools\MSVC\14.29.30133\bin\Hostx64\x86\dumpbin.exe" /DEPENDENTS mlpack\test_python_binding.cp38-win32.pyd
